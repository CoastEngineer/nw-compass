    ...
    return (
        <Page title="Dashboard" subtitle="A calm, precise cockpit for your family plan">
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                {/* ✅ Saving / Deficit (no clamp-to-zero) */}
                <KPIStatCard
                ...
                <KPIStatCard
                    ...
                    value={`${Math.round(cfg.cagr.bear * 100)} / ${Math.round(
                        cfg.cagr.base * 100
                    )} / ${Math.round(cfg.cagr.bull * 100)}%`}
                    sub="Assumption"
                />
            ...
            <div className="mt-6">
                <NWChart rows={rows} currency={display.currency} tableStep={display.tableStep} />
            </div>
